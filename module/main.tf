...
locals {
  counter_kb = local.create_kb || var.existing_kb != null || var.existing_kb != "" ? [1] : []
  ...
  knowledge_bases_value = {
    ...
    knowledge_base_id    = local.create_kb ? local.knowledge_base_id : (var.existing_kb != "" ? var.existing_kb : null)
